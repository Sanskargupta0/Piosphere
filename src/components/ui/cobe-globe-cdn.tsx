...
const defaultMarkers: CdnMarker[] = [
  { id: "cdn-iad", location: [38.95, -77.45], region: "Call Agent" },
  { id: "cdn-sfo", location: [37.62, -122.38], region: "Monitor Agent" },
  { id: "cdn-cdg", location: [49.01, 2.55], region: "File Agent" },
  { id: "cdn-hnd", location: [35.55, 139.78], region: "Legal Agent" },
  { id: "cdn-syd", location: [-33.95, 151.18], region: "Fraud Agent" },
  { id: "cdn-gru", location: [-23.43, -46.47], region: "Policy Agent" },
  { id: "cdn-sin", location: [1.36, 103.99], region: "Support Agent" },
  { id: "cdn-arn", location: [59.65, 17.93], region: "Ops Agent" },
  { id: "cdn-dub", location: [53.43, -6.25], region: "Research Agent" },
  { id: "cdn-bom", location: [19.09, 72.87], region: "Risk Agent" },
]
    ...
    <div className={`relative aspect-square select-none ${className}`}>
      ...
      {markers.map((m) => (
        ...
        >
          ...
          >
            <img
              src="/images/pv_green.png"
              alt="Piovation"
              className="block dark:hidden"
              style={{ width: "100%", height: "100%", objectFit: "contain" }}
            />
            <img
              src="/images/pv_white.png"
              alt="Piovation"
